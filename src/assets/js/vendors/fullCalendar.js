...
var FullCalendar = (function (exports) {
    ...
    function w$2(n, l, u, i, t, o, r, c, s, a) {
        ...
        for (u.__k = [], h = 0; h < l.length; h++)
            if (
                ...
                if (
                    ((k.__ = u), (k.__b = u.__b + 1), null === (d = x[h]) || (d && k.key == d.key && k.type === d.type))
                )
                    x[h] = void 0;
                else
                    for (y = 0; y < C; y++) {
    ...
    function $$1(n, l, u) {
        '-' === l[0]
            ? n.setProperty(l, u)
            : (n[l] = null == u ? '' : 'number' != typeof u || c$1.test(l) ? u : u + 'px');
    }
    ...
    */
    ...
    const EVENT_REFINERS = Object.assign(
        Object.assign(Object.assign({}, EVENT_NON_DATE_REFINERS), EVENT_DATE_REFINERS),
    ...
    class TableDateCell extends BaseComponent {
        render() {
            ...
            let renderProps = Object.assign(
                Object.assign(Object.assign({ date: dateEnv.toDate(date), view: viewApi }, props.extraRenderProps), {
                    text,
                }),
                dayMeta
            );
                ...
                (InnerContent, renderProps, elAttrs) =>
                    h(
                        ...
                        hasCustomDayCellContent(options) &&
                            h(InnerContent, { elTag: 'div', elClasses: ['fc-more-popover-misc'] }),
                        props.children
                    )
            );
        }
    ...
    */
    ...
    class CalendarDataManager {
        ...
        _computeOptionsData(optionOverrides, dynamicOptionOverrides, calendarApi) {
            ...
            let { refinedOptions, pluginHooks, localeDefaults, availableLocaleData, extra } =
    ...
    */
    ...
    function buildDateEnv(settings) {
        ...
        return new DateEnv(
            Object.assign(
                Object.assign({ timeZone: BASE_OPTION_DEFAULTS.timeZone, calendarSystem: 'gregory' }, settings),
                { locale }
            )
        );
    }
                ...
                if (!pointer.wasTouchScroll) {
                    ...
                    if (initialHit && finalHit && isHitsEqual(initialHit, finalHit)) {
                        ...
                        let arg = Object.assign(
                            Object.assign({}, buildDatePointApiWithContext(initialHit.dateSpan, context)),
                            {
            ...
            this.handleDragEnd = pev => {
                ...
                if (receivingContext && droppableEvent) {
                    ...
                    receivingContext.emitter.trigger(
                        'drop',
                        Object.assign(
                            Object.assign({}, buildDatePointApiWithContext(finalHit.dateSpan, receivingContext)),
                    ...
                    chunks: [
                        {
                            key: 'axis',
                            rowContent: arg =>
                                h('tr', { role: 'presentation' }, this.renderHeadAxis('day', arg.rowSyncHeights[0])),
                        },
                        {
                            key: 'cols',
                            elRef: this.headerElRef,
    ...
    */
    ...
    class TimeColMoreLink extends BaseComponent {
        render() {
            ...
            return h(
                ...
                InnerContent =>
                    h(InnerContent, { elTag: 'div', elClasses: ['fc-timegrid-more-link-inner', 'fc-sticky'] })
            );
        }
    }
    ...
    class TimeCol extends BaseComponent {
            ...
            return h(
                ...
                InnerContent =>
                    h(
                        ...
                        hasCustomDayCellContent(options) &&
                            h(InnerContent, { elTag: 'div', elClasses: ['fc-timegrid-col-misc'] })
                    )
            );
        }
        ...
        renderHiddenGroups(hiddenGroups, segs) {
            let { extraDateSpan, dateProfile, todayRange, nowDate, eventSelection, eventDrag, eventResize } =
                this.props;
            return h(
                p,
                null,
    ...
    function renderInnerContent(props) {
        return h(
            ...
            props.text &&
                h(
                    'a',
                    Object.assign({ id: props.textId, className: 'fc-list-day-text' }, props.navLinkAttrs),
                    props.text
                ),
            props.sideText &&
