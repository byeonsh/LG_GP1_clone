...
window._bd_share_main
    ...
    : ((window._bd_share_is_recently_loaded = !1),
      (window._bd_share_main = {
          version: '2.0',
          jscfg: { domain: { staticUrl: '/assets/baidumap/baiduShare-master/' } },
      })),
            ...
            (function (e, t) {
                ...
                function a(t, n, s, a) {
                    ...
                    'css' == n
                        ...
                        : ((d.type = 'text/javascript'), (d.src = t), l.insertBefore(d, l.firstChild));
                }
                function r(e, t) {
                    e.onload =
                        e.onerror =
                ...
                (e.each = n),
                    ...
                    (s.require = function (e, t) {
                        e.search(':') < 0 &&
                            (t || ((t = d), s.currentPath && (t = s.currentPath.split('/js/')[0].substr(1))),
                            (e = t + ':' + e));
                    ...
                    (s.getJsPath = function (t, n) {
                        ...
                        return (
                            -1 !== (o = t.indexOf('/')) &&
                                ((r = t.slice(0, o)), (c = t.lastIndexOf('/')), (_ = t.slice(c + 1))),
            ...
            var n = e('component/comm_tools'),
                ...
                _ = function (e) {
                    window._bd_share_main.F.use('base/tangram', function (t) {
                        var s = t.T;
                        s.browser.ie
                            ? (window.clipboardData.setData('text', document.title + ' ' + (e.bdUrl || n.getPageUrl())),
