...
var FullCalendar = (function (exports) {
  ...
  function b$1(n) {
    ((!n.__d && (n.__d = !0) && t.push(n) && !g$2.__r++) || o !== l$1.debounceRendering) &&
    ...
    for (u.__k = [], h = 0; h < l.length; h++)
      if (
        ...
        j$2(n, k, (d = d || f$1), t, o, r, c, s, a),
          ...
          null != b
            ? (null == g && (g = b),
              'function' == typeof k.type && k.__k === d.__k ? (k.__d = s = m$1(k, s, n)) : (s = A(n, k, d, x, b, s)),
  ...
  function H$1(n, l, u, i, t) {
    ...
    n: if ('style' === l)
      ...
      (o = l !== (l = l.replace(/Capture$/, ''))),
        ...
        n.l || (n.l = {}),
        (n.l[l + o] = u),
        u ? i || n.addEventListener(l, o ? T$1 : I$1, o) : n.removeEventListener(l, o ? T$1 : I$1, o);
      ...
      'function' == typeof u ||
        (null == u || (!1 === u && -1 == l.indexOf('-')) ? n.removeAttribute(l) : n.setAttribute(l, u));
    }
  }
  function I$1(n) {
    ...
    try {
      n: if ('function' == typeof T) {
        if (
          ...
          i.__c
            ...
            : ('prototype' in T && T.prototype.render
                ? (u.__c = h = new T(g, x))
                : ((u.__c = h = new d(g, x)), (h.constructor = T), (h.render = O)),
              m && m.sub(h),
              (h.props = g),
              h.state || (h.state = {}),
              (h.context = x),
          ...
          null != T.getDerivedStateFromProps &&
            (h.__s == h.state && (h.__s = s({}, h.__s)), s(h.__s, T.getDerivedStateFromProps(g, h.__s))),
          (y = h.props),
          (_ = h.state),
          v)
        )
          ...
          if (
            ...
            (!h.__e && null != h.shouldComponentUpdate && !1 === h.shouldComponentUpdate(g, h.__s, x)) ||
              u.__v === i.__v)
          ) {
            for (
              h.props = g,
        ...
        if (
          ...
          for (
            h.state = h.__s, h.__d = !1, C && C(u), a = h.render(h.props, h.state, h.context), H = 0;
            H < h._sb.length;
            H++
          )
            h.__h.push(h._sb[H]);
        ...
        null == r && u.__v === i.__v ? ((u.__k = i.__k), (u.__e = i.__e)) : (u.__e = L$1(i.__e, u, i, t, o, r, f, c));
      (a = l$1.diffed) && a(u);
    } catch (n) {
  ...
  function L$1(l, u, i, t, o, r, e, c) {
    ...
    if (null === d) y === p || (c && l.data === p) || (l.data = p);
      ...
      if (
        ...
        if (null != r)
          for (y = {}, k = 0; k < l.attributes.length; k++) y[l.attributes[k].name] = l.attributes[k].value;
        (v || h) &&
          ((v && ((h && v.__html == h.__html) || v.__html === l.innerHTML)) || (l.innerHTML = (v && v.__html) || ''));
      }
      if ((C$1(l, p, y, o, c), v)) u.__k = [];
      else if (
        ((k = u.props.children),
        w$2(l, Array.isArray(k) ? k : [k], u, i, t, o && 'foreignObject' !== d, r, e, r ? r[0] : i.__k && _(i, 0), c),
        null != r)
      )
  ...
  (l$1.__b = function (n) {
    ...
    (l$1.diffed = function (t) {
      ...
      o &&
        o.__H &&
        (o.__H.__h.length &&
          ((1 !== f.push(o) && i === l$1.requestAnimationFrame) || ((i = l$1.requestAnimationFrame) || j$1)(b)),
  ...
  l$1.event = function (n) {
    return (
      G && (n = G(n)), (n.persist = J), (n.isPropagationStopped = K), (n.isDefaultPrevented = Q), (n.nativeEvent = n)
    );
  };
  var nn = {
      configurable: !0,
  ...
  function getEventTargetViaRoot(ev) {
    var _a, _b;
    return (_b = (_a = ev.composedPath) === null || _a === void 0 ? void 0 : _a.call(ev)[0]) !== null && _b !== void 0
      ? _b
      : ev.target;
  }
  ...
  class DateEnv {
    constructor(settings) {
      ...
      this.weekTextLong =
        (settings.weekTextLong != null ? settings.weekTextLong : settings.locale.options.weekTextLong) || this.weekText;
  ...
  class ContentInjector extends BaseComponent {
    ...
    render() {
      ...
      if (hasCustomRenderingHandler(props.generatorName, options)) {
        ...
        if (typeof customContent === 'string' || i$1(customContent) || Array.isArray(customContent)) {
  ...
  class ContentContainer extends d {
    ...
    componentDidMount() {
      ...
      (_b = (_a = this.props).didMount) === null || _b === void 0
        ? void 0
        : _b.call(_a, Object.assign(Object.assign({}, this.props.renderProps), { el: this.base }));
    }
    componentWillUnmount() {
      var _a, _b;
  ...
  function generateClassNames(classNameGenerator, renderProps) {
    const classNames =
      typeof classNameGenerator === 'function' ? classNameGenerator(renderProps) : classNameGenerator || [];
  ...
  function receiveResponse(sourceHash, sourceId, fetchId, fetchRange) {
    ...
    if (
      ...
      return Object.assign(Object.assign({}, sourceHash), {
        [sourceId]: Object.assign(Object.assign({}, eventSource), { isFetching: false, fetchRange }),
      });
    }
    return sourceHash;
  }
  ...
  function triggerDateSelect(selection, pev, context) {
    context.emitter.trigger(
      'select',
      Object.assign(Object.assign({}, buildDateSpanApiWithContext(selection, context)), {
  ...
  function handleDateProfile(dateProfile, context) {
    context.emitter.trigger(
      'datesSet',
      Object.assign(Object.assign({}, buildRangeApiWithTimeZone(dateProfile.activeRange, context.dateEnv)), {
        view: context.viewApi,
      })
    );
  }
  ...
  class TableDateCell extends BaseComponent {
    render() {
      ...
      let renderProps = Object.assign(
        Object.assign(Object.assign({ date: dateEnv.toDate(date), view: viewApi }, props.extraRenderProps), { text }),
        dayMeta
      );
      return h(
        ContentContainer,
  ...
  function isDateSelectionPropsValid(state, context, dateSpanMeta, filterConfig) {
    ...
    // constraint
    if (
      !allConstraintsPass(selectionConfig.constraints, selectionRange, relevantEventStore, state.businessHours, context)
    ) {
      return false;
    }
    // overlap
    ...
    for (let relevantInstanceId in relevantInstances) {
      ...
      if (rangesIntersect(selectionRange, relevantInstance.range)) {
        ...
        if (
          selectOverlapFunc &&
          !selectOverlapFunc(new EventImpl(context, relevantDefs[relevantInstance.defId], relevantInstance), null)
        ) {
          return false;
        }
      }
  ...
  class SimpleScrollGrid extends BaseComponent {
    ...
    render() {
      ...
      return h(
        ...
        Boolean(!isBuggy && headSectionNodes.length) && h('thead', roleAttrs, ...headSectionNodes),
        Boolean(!isBuggy && bodySectionNodes.length) && h('tbody', roleAttrs, ...bodySectionNodes),
        Boolean(!isBuggy && footSectionNodes.length) && h('tfoot', roleAttrs, ...footSectionNodes),
        isBuggy && h('tbody', roleAttrs, ...headSectionNodes, ...bodySectionNodes, ...footSectionNodes)
      );
    }
        ...
        (InnerContent, eventContentArg) =>
          h(
            ...
            Boolean(eventContentArg.isStartResizable) &&
              h('div', { className: 'fc-event-resizer fc-event-resizer-start' }),
  ...
  function refineRenderProps(raw) {
    ...
    return Object.assign(
      Object.assign(Object.assign({ date: dateEnv.toDate(date), view: raw.viewApi }, dayMeta), {
  ...
  class MorePopover extends DateComponent {
    ...
    render() {
      ...
      return h(
        DayCellContainer,
        { elRef: this.handleRootEl, date: startDate, dateProfile: dateProfile, todayRange: todayRange },
          ...
          Boolean(props.moreCnt) &&
            h(
              ContentContainer,
              {
                ...
                elAttrs: Object.assign(
                  Object.assign(Object.assign({}, props.elAttrs), createAriaClickAttrs(this.handleClick)),
                  {
                    title: hint,
                ...
                generator: options.moreLinkContent || props.defaultGenerator || renderMoreLinkInner$1,
  ...
  function buildViewSpecs(defaultInputs, optionOverrides, dynamicOptionOverrides, localeDefaults) {
    ...
    return mapHash(viewDefs, viewDef =>
      buildViewSpec(viewDef, overrideConfigs, optionOverrides, dynamicOptionOverrides, localeDefaults)
    );
  }
  function buildViewSpec(viewDef, overrideConfigs, optionOverrides, dynamicOptionOverrides, localeDefaults) {
    ...
    return {
      ...
      // not DRY
      buttonTitleOverride:
        queryButtonTitle(dynamicOptionOverrides) || queryButtonTitle(optionOverrides) || viewDef.overrides.buttonHint,
      buttonTitleDefault:
        queryButtonTitle(localeDefaults) || viewDef.defaults.buttonHint || queryButtonTitle(BASE_OPTION_DEFAULTS),
  ...
  class CalendarDataManager {
    ...
    resetOptions(optionOverrides, append) {
      ...
      props.optionOverrides = append
        ? Object.assign(Object.assign({}, props.optionOverrides), optionOverrides)
        : optionOverrides;
    ...
    processRawCalendarOptions(optionOverrides, dynamicOptionOverrides) {
      let { locales, locale } = mergeRawOptions([BASE_OPTION_DEFAULTS, optionOverrides, dynamicOptionOverrides]);
      ...
      let refiners = (this.currentCalendarOptionsRefiners = Object.assign(
        Object.assign(
          Object.assign(
            Object.assign(Object.assign({}, BASE_OPTION_REFINERS), CALENDAR_LISTENER_REFINERS),
        ...
        if (buttonName === 'title') {
          ...
          children.push(
            h(
              ...
              buttonText || (buttonIcon ? h('span', { className: buttonIcon }) : '')
            )
          );
        }
      }
      ...
      return h(
        ...
        toolbarConfig.footer &&
          h(
            Toolbar,
            Object.assign(
              { ref: this.footerRef, extraClassName: 'fc-footer-toolbar', model: toolbarConfig.footer, titleId: '' },
              toolbarProps
            )
          )
      );
        ...
        if (this.isRendering) {
          ...
          flushSync(() => {
            P$1(
              h(
                CalendarRoot,
                { options: currentData.calendarOptions, theme: currentData.theme, emitter: currentData.emitter },
  ...
  function buildDateEnv(settings) {
    ...
    return new DateEnv(
      Object.assign(Object.assign({ timeZone: BASE_OPTION_DEFAULTS.timeZone, calendarSystem: 'gregory' }, settings), {
        locale,
      })
    );
  }
          ...
          if (validMutation) {
            ...
            if (receivingContext === initialContext) {
              ...
              initialContext.emitter.trigger(
                'eventDrop',
                Object.assign(Object.assign(Object.assign({}, eventChangeArg), transformed), {
                  el: ev.subjectEl,
              ...
              initialContext.emitter.trigger(
                'eventLeave',
                Object.assign(Object.assign({}, eventRemoveArg), { draggedEl: ev.subjectEl, view: initialView })
              );
              initialContext.dispatch({
                type: 'REMOVE_EVENTS',
                eventStore: relevantEvents,
              ...
              receivingContext.emitter.trigger(
                'drop',
                Object.assign(Object.assign({}, buildDatePointApiWithContext(finalHit.dateSpan, receivingContext)), {
      ...
      return h(
        ...
        (InnerContent, renderProps) =>
          h(
            ...
            Boolean(
              !renderProps.isDisabled && (props.showDayNumber || hasCustomDayCellContent(options) || props.forceDayTop)
            ) &&
              h(
                'div',
      ...
      return h(
        ...
        props.cells.map((cell, col) => {
          ...
          return h(TableCell, {
            ...
            fgContent: h(p, null, h(p, null, normalFgNodes), h(p, null, mirrorFgNodes)),
            // Fragment scopes the keys
            bgContent: h(
              p,
              null,
  ...
  class Table extends DateComponent {
    ...
    render() {
      ...
      return h(
        ...
        h(NowTimer, { unit: 'day' }, (nowDate, todayRange) =>
          h(
            p,
            null,
            h(
    ...
    return h(ViewContextType.Consumer, null, context => {
      ...
      return h(
        ContentContainer,
        {
          ...
          generator: options.slotLabelContent || renderInnerContent$1,
  ...
  class TimeBodyAxis extends BaseComponent {
    render() {
      return this.props.slatMetas.map(slatMeta =>
        h('tr', { key: slatMeta.key }, h(TimeColsAxisCell, Object.assign({}, slatMeta)))
      );
    }
  }
        ...
        return (
          ...
          h(
            ContentContainer,
            {
              ...
              generator: options.allDayContent || renderAllDayInner$1,
          ...
          chunks: [
            {
              ...
              rowContent: contentArg =>
                h('tr', { role: 'presentation' }, this.renderTableRowAxis(contentArg.rowSyncHeights[0])),
            },
            {
              key: 'cols',
    ...
    const stretchNode = cacheable(
      ...
      (node, startCoord, prevThickness) => {
        ...
        return [
          ...
          Object.assign(Object.assign({}, node), { thickness: newThickness, nextLevelNodes: newChildren }),
        ];
      }
    );
  ...
  function webToRects(topLevelNodes) {
    ...
    const processNode = cacheable(
      ...
      (node, levelCoord, stackDepth) => {
        let rect = Object.assign(Object.assign({}, node), { levelCoord, stackDepth, stackForward: 0 });
        rects.push(rect);
  ...
  function renderPlainFgSegs(sortedFgSegs, { todayRange, nowDate, eventSelection, eventDrag, eventResize }) {
    let hiddenInstances =
      (eventDrag ? eventDrag.affectedInstances : null) || (eventResize ? eventResize.affectedInstances : null) || {};
    return h(
      p,
      null,
  ...
  class DayTimeCols extends DateComponent {
    ...
    render() {
      ...
      return h(NowTimer, { unit: isNowIndicator ? 'minute' : 'day' }, (nowDate, todayRange) =>
        h(
          TimeCols,
          Object.assign(
  ...
  const STOCK_SUB_DURATIONS = [{ hours: 1 }, { minutes: 30 }, { minutes: 15 }, { seconds: 30 }, { seconds: 15 }];
      ...
      return h(
        ...
        (
          ...
          h(
            ...
            h(InnerContent, { elTag: 'div', elClasses: ['fc-list-day-cushion', theme.getClass('tableCellShaded')] })
          )
      );
    }
  }
  function renderInnerContent(props) {
    return h(
      ...
      null,
      props.text &&
        h('a', Object.assign({ id: props.textId, className: 'fc-list-day-text' }, props.navLinkAttrs), props.text),
      props.sideText &&
  ...
  class ListView extends DateComponent {
    ...
    renderEmptyMessage() {
      ...
      return h(
        ...
        InnerContent => h(InnerContent, { elTag: 'div', elClasses: ['fc-list-empty-cushion'] })
      );
    }
