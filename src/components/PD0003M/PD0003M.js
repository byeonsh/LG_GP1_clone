...
import { addKeyWordToCookie, beforeLaunch, getComponentConfigFromElem } from '../../assets/js/common/utils.js';
...
const focusHandler = e => {
  ...
  isFocusable =
    ...
    !!target.closest('.PD0003M .c-summary-area__secondary');
  // Value Assign
...
// component
function init() {
  const component = document.querySelector('.PD0003M');
